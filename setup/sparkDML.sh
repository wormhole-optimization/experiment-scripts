...
DEFAULT_SYSTEMML_HOME=/home/wopt/wormhole/systemml-perftest/perftest
...
num_executors="--num-executors 6"
executor_memory="--executor-memory 100G"
executor_cores="--executor-cores 16"
